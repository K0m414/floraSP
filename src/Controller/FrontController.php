...
#[Route('/report-comment/{id}', name: 'app_front_report_comment', methods: ['POST'])]
    public function reportComment(Comment $comment, CommentRepository $commentRepository, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->redirectToRoute('app_front_show', ['id' => $comment->getArticle()->getId()]);
    }
